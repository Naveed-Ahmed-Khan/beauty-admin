    ...
    <div className="container mx-auto px-4 sm:px-8 max-w-3xl">
      <div className="">
        ...
        <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
          <div className="bg-secondary bg-opacity-20 h-[21rem] inline-block min-w-full shadow rounded-3xl overflow-auto scrollbar-thin scrollbar-thumb-zinc-600  scrollbar-track-transparent">
